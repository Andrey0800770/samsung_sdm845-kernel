...
static const struct freq_tbl  ftbl_gpu_cc_gx_gfx3d_clk_src_sdm845_v2[] = {
	...
	F(347000000, P_CRC_DIV,  1, 0, 0),
	F(437000000, P_CRC_DIV,  1, 0, 0),
	F(527000000, P_CRC_DIV,  1, 0, 0),
	F(617000000, P_CRC_DIV,  1, 0, 0),
	F(707000000, P_CRC_DIV,  1, 0, 0),
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOW] = 347000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOW_L1] = 437000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_NOMINAL] = 527000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_NOMINAL_L1] = 617000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH] = 707000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH_L1] = 800000000;
}
